    ...
    <View style={tailwind("bg-gray-100 rounded-xl mt-8 flex flex-col p-4")}>
      <View style={tailwind("flex flex-row justify-between")}>
        ...
        <View style={tailwind("flex flex-row items-center")}>
          <Text style={tailwind("text-black-500 font-bold text-lg")}>$</Text>
      ...
      <View style={tailwind("flex flex-row justify-between mt-3")}>
        ...
        <View style={tailwind("flex flex-row items-center")}>
          <Text style={tailwind("text-black-500 font-bold text-lg")}>$</Text>
          <Text style={tailwind("text-black font-bold text-xl")}> 100.00</Text>
        </View>
      </View>
      <View style={[{ height: 1, overflow: "hidden", marginVertical: 15 }]}>
        <View
          style={[
            {
              height: 2,
      ...
      <View style={tailwind("flex flex-row justify-between")}>
        <Text style={tailwind("text-gray-400 font-bold text-lg")}>Total</Text>
        <View style={tailwind("flex flex-row items-center")}>
          <Text style={tailwind("text-black-500 font-bold text-lg")}>$</Text>
          <Text style={tailwind("text-black font-bold text-xl")}>
            {" "}
...
const BicycleCard = () => {
  ...
  return (
    ...
    >
      <View style={tailwind("flex flex-row justify-between rounded-lg w-full")}>
        <View style={tailwind("flex flex-row")}>
          <View style={tailwind("bg-gray-100 rounded-xl p-2")}>
            <Image
              source={require("../assets/images/bicycle.jpeg")}
              style={tailwind("w-20 h-20")}
            />
          </View>

          <View style={tailwind("flex flex-col justify-between ml-5")}>
            <Text style={tailwind("text-black text-xl")}>Pinarello Bike</Text>
            <Text style={tailwind("text-gray-400 text-sm")}>Mountain Bike</Text>
            <View style={tailwind("flex flex-row")}>
              <Text style={tailwind("text-black-500 font-bold text-xl")}>
                $
              </Text>
              <Text style={tailwind("text-black font-bold text-2xl")}>
                {" "}
                {Number(amount * 8000).toFixed(2)}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={tailwind("flex flex-col justify-between items-end")}>
          ...
          <View style={tailwind("flex flex-row items-center")}>
            ...
            <Text style={tailwind("text-black font-bold text-2xl mx-3")}>
              {amount}
            </Text>
            <TouchableOpacity
              style={tailwind(
      ...
      <View style={tailwind("px-4")}>
        <View style={tailwind("flex flex-row justify-between items-center")}>
          ...
          <View style={tailwind("flex flex-col items-center")}>
            <Text style={tailwind("text-xl font-bold")}>Cart list</Text>
            <Text style={tailwind("text-sm font-bold text-gray-400")}>
              (3 items)
            </Text>
          </View>
          <View style={tailwind("flex flex-row")}>
        ...
        <Subtotal />
        <TouchableOpacity
          style={tailwind("bg-yellow-500 mt-4 p-4 rounded-xl items-center")}
        >
