...
const Category = ({ item }) => {
  return (
    <TouchableOpacity style={tailwind("bg-gray-100 p-2 rounded-lg mr-3 px-4")}>
      <Text
        style={tailwind(
  ...
  return (
    ...
    >
      ...
      <View style={tailwind("mt-3 items-center")}>
        <Text style={tailwind("text-gray-400 text-xl")}>Mountain Bike</Text>
        <View style={tailwind("flex flex-row")}>
          <Text style={tailwind("text-black-500 font-bold text-xl")}>$</Text>
          <Text style={tailwind("text-black font-bold text-xl")}>8,00.00</Text>
        </View>
      </View>
    </TouchableOpacity>
  );
    ...
    <SafeAreaView style={tailwind("h-full w-full flex bg-white")}>
      <View style={tailwind("px-4")}>
        ...
        <View style={tailwind("mt-3 flex flex-row items-end")}>
          <Text style={tailwind("text-gray-500 text-2xl")}>The World's</Text>
          <Text style={tailwind("text-yellow-500 text-3xl font-bold")}>
            {" "}
            Best Bike
          </Text>
        </View>
